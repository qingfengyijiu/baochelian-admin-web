...
class ListPage extends React.Component {
    ...
    componentDidMount() {
        ...
        actions.utilAction.changeNavActive(navIds.SPECIFICATION_CATEGORY_LIST);
        this.refresh();
    }
        ...
        return (
            <div className="fbt-table">
                ...
                <div className="grid-operation-zone">
                    <Link className="btn btn-primary" to="/specificationCategory/add">新增</Link>
                </div>
...
function mapStateToProps(state) {
    let listState = state.reducers.specificationCategory.toJS().list;
    return {...listState};
}
