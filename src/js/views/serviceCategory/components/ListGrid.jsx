...
export default class extends React.Component {
    ...
    constructor(props) {
        ...
        this.colModels = [{
            ...
            formatter: function(value, options, rowObject) {
                if(value && value != "") {
                    return (
                        <img src={value} style={{width: "20px", height: "20px"}}/>
                    )
                } else {
                    return undefined;
                }
            ...
            formatter: function(value, options, rowObject) {
                ...
                return (
                    <div>
                        <Link to={'/serviceCategory/' + id + '/update'}>编辑</Link>
    ...
    refresh() {
        ...
        ws.get({
              ...
              actions.utilAction.hideLoading();
              if(response.code == 0) {
                  actions.thisAction.changeListData(response.data.bizServiceCategories);
