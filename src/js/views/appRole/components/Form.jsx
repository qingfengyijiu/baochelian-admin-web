    ...
    render() {
        ...
        return (
            <div className="form cp-form">
              ...
              <FormField label="APP名称" required error={errors.name}>
                  <FormField.Input value={model.name} required disabled={ roleType == '1' ? 'disabled' : undefined } onChange={this.onChangeField('name').bind(this)}/>
              </FormField>
