...
export default class Grid extends React.Component {
    ...
    render() {
        ...
        let {dataSource, pagination,  pagerSize, searchOptions, colModels, keyName, changePage, showSerial} = this.props;
        ...
        return (
            <div className="grid-container">
                <Table colModels={colModels} datas={datas} keyName={keyName} showSerial={showSerial}/>
                <div className="clearfix">
                    <Pagination current={pageCurrent} total={pageTotal} size={pagerSize} changePage={changePage}/>
                </div>
            </div>
        )
    }
